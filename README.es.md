...
Aprender en público significa colaboración. Y no por ello tienes que ser un experto para colaborar. ¡Los errores ortográficos vienen al rescate!

es el perfecto rompe-hielos para las contribuciones de código abierto. Arreglar un error ortográfico es fácil y no requiere ninguna experiencia en Github.
